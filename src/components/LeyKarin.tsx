        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-5 fade-in-section">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-4 -right-4 bg-naranja/10 w-full h-full rounded-lg -z-10"></div>
            </div>
            
            <div className="flex items-center gap-4 bg-gris p-4 rounded-lg border-l-4 border-celeste">
              <Shield className="text-celeste w-8 h-8" />
          ...
          <Card className="md:col-span-7 border-none shadow-xl rounded-lg overflow-hidden bg-white relative fade-in-section">
            <div className="absolute top-0 left-0 w-2 h-full bg-gradient-to-b from-naranja to-amarillo"></div>
            <CardContent className="p-8">
              <div className="flex items-start gap-4 mb-6">
                <BookOpen className="w-10 h-10 text-naranja flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-xl font-bold mb-2 text-azul">¿Qué es la Ley Karin?</h3>
              ...
              <p className="text-lg mb-4 bg-naranja/10 p-4 rounded-lg border-l-2 border-naranja">
