      ...
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-6">
            ...
            <img alt="Mutual de Seguridad Logo" src="/lovable-uploads/e553e536-691a-4d35-86b3-8f401cf79873.png" className="h-14 md:h-20 w-auto transition-transform hover:scale-95" />
          </div>
        </div>
