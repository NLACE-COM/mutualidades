      ...
      <div className="container mx-auto px-4 pt-16 md:pt-24">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-5 fade-in-section">
            <h2 className="text-4xl font-bold mb-6 text-[#333333] leading-tight">DECRETO SUPREMO N° 44</h2>
          ...
          <Card className="md:col-span-6 border-none shadow-xl rounded-lg overflow-hidden bg-white relative fade-in-section">
            ...
            <CardContent className="p-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-5 text-[#333333]">Principales características</h3>
                <ul className="list-disc pl-6 space-y-4 text-2xl text-[#606060]">
              <li>Actualiza la gestión de riesgos con enfoque de género.</li>
              <li>Nuevas obligaciones para la SST.</li>
              <li>Requisitos según el tamaño de la entidad empleadora.</li>
              <li>Promueve la capacitación de las personas trabajadoras.</li>
              <li>Fomenta entornos laborales más seguros y saludables.</li>
              <li>Promueve la mejora continua en la gestión preventiva.</li>
            </ul>
                </div>
              </div>
