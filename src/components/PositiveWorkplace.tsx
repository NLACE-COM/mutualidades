  ...
  const positiveActions = [
    {
      ...
      icon: <Heart className="w-8 h-8 text-naranja mb-4" />
    },
    {
      title: "Evita gritar o descalificar",
      icon: <MessageSquare className="w-8 h-8 text-naranja mb-4" />
    },
    {
    ...
    },
    {
      ...
      icon: <Users className="w-8 h-8 text-naranja mb-4" />
    },
    {
    ...
    },
    {
      ...
      icon: <Check className="w-8 h-8 text-naranja mb-4" />
    }
  ];
    ...
    <section className="bg-white section-padding">
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto text-center mb-12 fade-in-section">
          <h2 className="text-4xl font-bold text-azul">¿QUÉ SIGNIFICA APORTAR A UN ENTORNO LABORAL POSITIVO?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {positiveActions.map((action, index) => (
            <Card 
              key={index} 
              className="border-none shadow-md hover:shadow-lg transition-shadow duration-300 rounded-lg overflow-hidden bg-gradient-to-br from-white to-gris"
            >
