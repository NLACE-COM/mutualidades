...
const Formulariounico = () => {
  return <section id="decretosupremo" className="bg-[#EFF2F3] scroll-mt-20 pb-16 md:pb-10 relative " style={{
    position: 'relative',
    zIndex: 10
  }}>
    ...
    />
    <h2 className="text-2xl font-bold text-[#333333] leading-tight">
      ...
      y salud laboral
            ...
            <div className="w-20 h-1 bg-[#f5a034] mb-8"></div>
                ...
                <div>
          <p className="text-md text-[#606060]">Porque cuando se trata de cuidar a las personas el FUF cumple un rol clave.
Y en el mundo laboral, eso se traduce en algo concreto: revisar, evaluar y asegurar que las normas de seguridad se estén cumpliendo.</p>
        <h3>¿Qué es el FUF y a qué le ponemos ojo?</h3>
          <p className="text-md text-[#606060]">El Formulario Único de Fiscalización (FUF) del D.S. N.° 44/2024 sobre gestión preventiva de los riesgos 
      ...
      <p className="text-md text-[#606060]">Cuando se trata del cuidado de las personas en su entorno laboral, el FUF D.S. N.° 44 cumple un rol
 ...
 <Card className="md:col-span-7 border-none shadow-xl rounded-lg bg-white relative fade-in-section overflow-visible">
  ...
  <CardContent className="p-8 overflow-visible">
    <div className="flex items-start gap-4 mb-6">
      <div>
        <h3 className="text-xl font-bold mb-5 text-[#333333]">¿Para qué sirve el FUF DS N°44?</h3>
        <ul className="list-disc pl-6 space-y-2 texto-fuf text-[#333333]">
    ...
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end mt-10 relative">
     ...
     <img
  src="/lovable-uploads/chef-ojo-fuf.png"
  alt="Personaje con ojo gigante representando la fiscalización"
  className="w-full max-w-[200px] h-auto object-contain relative lg:absolute lg:bottom-0 lg:left-0 lg:-mb-0 lg:scale-150 drop-shadow-xl"
/>
      </div>

      {/* Columna texto + botón */}
      <div className="md:col-span-8">
        <h3 className="text-xl font-bold mb-4 text-[#333333] leading-snug">
        ...
        <a href="#"
          ...
          Descubre más y descarga el FUF aquí.
        </a>
      </div>
    </div>
  </CardContent>
