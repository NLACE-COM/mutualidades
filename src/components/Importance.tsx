...
const Importance: React.FC = () => {
  return (
    <section id="importancia" className="bg-gradient-to-b from-white to-[#f3f3e9] section-padding scroll-mt-20 relative">
      <div className="absolute top-0 right-0 w-1/3 h-1/2 bg-[#f5a034]/5 rounded-bl-full -z-10"></div>
      <div className="absolute bottom-0 left-0 w-1/4 h-1/3 bg-[#108cb0]/5 rounded-tr-full -z-10"></div>
          ...
          <div className="md:col-span-7 fade-in-section">
            <div className="bg-white rounded-xl shadow-lg p-8 md:p-10 relative">
              ...
              <div className="mb-8 flex items-start gap-4">
                <div className="bg-[#ffc000]/20 p-3 rounded-full">
              ...
              <div className="mb-8 flex items-start gap-4">
                <div className="bg-[#f5a034]/20 p-3 rounded-full">
              ...
              <div className="mb-8 flex items-start gap-4">
                <div className="bg-[#108cb0]/20 p-3 rounded-full">
              ...
              <div className="mt-10 p-6 bg-gradient-to-r from-[#f5a034]/20 to-[#ffc000]/20 rounded-lg border-l-4 border-[#f5a034]">
